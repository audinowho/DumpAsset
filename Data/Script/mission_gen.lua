...
"cacnea","cacturne","camerupt","carnivine","carvanha","cascoon","castform","caterpie","charmander","charmeleon","charizard","chandelure","chansey","chatot","cherrim","cherubi","chespin","chikorita","chimchar","chimecho","chinchou","chingling","cinderace","clamperl","claydol","clefable","clefairy","cleffa","clobbopus","cloyster","combee","combusken","corphish","corsola","corviknight","cradily","cramorant","cranidos","crawdaunt","croagunk","crobat","croconaw","cubchoo","cursola","cutiefly","cyndaquil",
"dartrix","decidueye","deerling","deino","delibird","delphox","dewgong","dewott","diglett","ditto","dodrio","doduo","donphan","dragonair","dragonite","drampa","drapion","dratini","drifblim","drifloon","drowzee","dugtrio","dunsparce","duosion","dusclops","dusknoir","duskull","dustox",
"ekans","electabuzz","electivire","electrike","electrode","elekid","emboar","emolga","empoleon","espurr","exeggcute","exeggutor","exploud",
"farfetchd","fearow","feebas","fennekin","feraligatr","finneon","flabebe","flaaffy","floatzel","floette","florges","flygon","fomantis","forretress","froakie","froslass","fuecoco","furret",
"gabite","gallade","galvantula","garchomp","gardevoir","gastly","gastrodon","gengar","geodude","gible","girafarig","glalie","glameow","gligar","gliscor","gloom","golbat","goldeen","golduck","golem","golisopod","golurk","goodra","goomy","gorebyss","gothita","gothitelle","gothorita","gourgeist","granbull","graveler","greninja","grimer","grotle","grovyle","growlithe","grumpig","gulpin","gyarados",
...
"igglybuff","illumise","incineroar","indeedee","infernape","ivysaur",
...
"lairon","lampent","lanturn","lapras","larvitar","leavanny","ledian","ledyba","lileep","lillipup","linoone","litten","litwick","lombre","lopunny","lotad","loudred","ludicolo","lumineon","lunatone","luvdisc","luxio","luxray",
"magby","machamp","machoke","machop","magcargo","magikarp","magmar","magmortar","magnemite","magneton","magnezone","makuhita","mamoswine","mandibuzz","manectric","mankey","mantine","mantyke","maractus","mareanie","mareep","marill","marshtomp","masquerain","mawile","medicham","meditite","meganium","meowstic","metagross","metang","metapod","mienfoo","mightyena","milotic","miltank","mime_jr","minccino","minior","minun","misdreavus","mismagius","monferno","morgrem","mothim","mr_mime","mudkip","muk","munchlax","murkrow",
...
"pachirisu","paras","parasect","pawniard","phantump","pidgeot","pidgeotto","pidgey","pidove","pignite","piloswine","pineco","pinsir","piplup","plusle","politoed","poliwag","poliwhirl","poliwrath","ponyta","poochyena","popplio","porygon","porygon_z","porygon2","primarina","primeape","prinplup","probopass","psyduck","pumpkaboo","pupitar","purrloin","purugly",
"quagsire","quaxly","quilava","qwilfish",
"raboot","ralts","rampardos","rapidash","raticate","rattata","relicanth","remoraid","rhydon","rhyhorn","rhyperior","ribombee","roggenrola","roselia","roserade","rowlet",
"sableye","salamence","salandit","salazzle","samurott","sandile","sandshrew","sandslash","sandygast","sawsbuck","sceptile","scizor","scorbunny","scrafty","scyther","seadra","seaking","sealeo","seedot","seel","sentret","serperior","servine","seviper","sewaddle","sharpedo","shedinja","shellder","shellos","shelgon","shieldon","shiftry","shinx","shroomish","shuckle","shuppet","silcoon","sinistea","skarmory","skiploom","skorupi","skuntank","slaking","slakoth","sliggoo","slowbro","slowking","slowpoke","slugma","smeargle","smoochum","sneasel","snivy","snorlax","snorunt","snover","snubbull","sobble","solrock","spearow","spheal","spinarak","spinda","spiritomb","spoink","sprigatito","squirtle","stantler","staraptor","staravia","starly","starmie","staryu","steelix","steenee","stoutland","stunky","sudowoodo","sunflora","sunkern","surskit","swablu","swalot","swampert","swellow","swinub","swirlix","swoobat",
"taillow","tangela","tangrowth","tauros","teddiursa","tentacool","tentacruel","tepig","thievul","togedemaru","togekiss","togepi","togetic","torchic","torkoal","torterra","totodile","toxicroak","trapinch","treecko","tropius","trubbish","tsareena","turtwig","tympole","typhlosion","tyranitar","tyrogue",
"ursaring",
"vanillish","vanillite","venomoth","venonat","venusaur","vespiquen","vibrava","victreebel","vigoroth","vileplume","volbeat","voltorb",
"wailmer","wailord","walrein","wartortle","weedle","weepinbell","weezing","whimsicott","whiscash","whismur","wigglytuff","wobbuffet","woobat","wooloo","wooper","wormadam","wurmple","wynaut",
"xatu",
"yanma","yanmega",
...
MISSION_GEN.POKEMON = {
	...
	"cacnea","carvanha","cascoon","caterpie","charmander","cherubi","chespin","chikorita","chimchar","chinchou","chingling","clamperl","cleffa","clobbopus","combee","corphish","cranidos","croagunk","cubchoo","cutiefly","cyndaquil",
	"deerling","deino","diglett","doduo","dratini","drifloon","drowzee","duskull",
	"ekans","electrike","elekid","espurr","exeggcute",
	"feebas","fennekin","finneon","flabebe","fomantis","froakie","fuecoco",
	...
	"larvitar","ledyba","lileep","lillipup","litten","litwick","lotad","luvdisc",
	"machop","magby","magikarp","magnemite","makuhita","mankey","mantyke","mareanie","mareep","meditite","metapod","mienfoo","mime_jr","minccino","mudkip","murkrow",
	"natu","nidoran_m","nidoran_f","nincada","noibat","nosepass","numel",
	"oddish","omanyte","onix","oshawott",
	"paras","pawniard","phantump","pidgey","pidove","pineco","piplup","poliwag","ponyta","poochyena","popplio","porygon","psyduck","pumpkaboo","purrloin",
	"quaxly",
	"ralts","rattata","remoraid","rhyhorn","roggenrola","rowlet",
	"salandit","sandile","sandshrew","sandygast","seedot","seel","sentret","sewaddle","shellder","shellos","shieldon","shinx","shroomish","shuppet","silcoon","sinistea","skorupi","slakoth","slowpoke","slugma","smoochum","sneasel","snivy","snom","snorunt","snover","snubbull","sobble","spearow","spheal","spinarak","spoink","sprigatito","squirtle","starly","staryu","stunky","sunkern","surskit","swablu","swinub","swirlix",
	"taillow","teddiursa","tentacool","tepig","torchic","togepi","totodile","trapinch","treecko","trubbish","turtwig","tympole","tyrogue",

	"vanillite","venonat","voltorb",
	"wailmer","weedle","whismur","woobat","wooloo","wooper","wurmple","wynaut",
	...
	"carnivine","castform","chansey","charmeleon","chatot","cherrim","chimecho","clefairy","combusken","corsola","cramorant","croconaw",
	"dartrix","delibird","dewott","ditto","dodrio","dragonair","dunsparce","duosion","dustox",
	"electabuzz","emboar","emolga",
	"farfetchd","flaaffy","floette","furret",
	"gabite","girafarig","gligar","gloom","golbat","gothorita","granbull","graveler","grotle","grovyle",
	"hattrem","haunter",
	"illumise","indeedee","ivysaur",
	"jigglypuff","jynx",
	"kadabra","kangaskhan","kirlia","kricketune",
	"lairon","lampent","ledian","linoone","lombre","loudred","lunatone","luxio",
	"machoke","magmar","magneton","maractus","marill","marshtomp","masquerain","mawile","metang","mightyena","miltank","minior","minun","misdreavus","monferno","morgrem","mothim","mr_mime","munchlax",
	"nidorina","nidorino","ninjask","noctowl","nuzleaf",

	"pachirisu","parasect","pidgeotto","pignite","piloswine","plusle","poliwhirl","porygon2","prinplup","pupitar",
	"quilava","qwilfish",
	"raboot","raticate","relicanth","ribombee","roselia",
	"sableye","scyther","seadra","sealeo","servine","seviper","shedinja","shelgon","shuckle","skiploom","sliggoo","smeargle","solrock","spinda","stantler","staravia","steenee","sudowoodo","sunflora",
	"tangela","thievul","togedemaru","togetic","torkoal","tropius",
	...
	TIER_HIGH = 
	{"absol","aerodactyl","aggron","alakazam","alcremie","altaria","ambipom","ampharos","appletun","arcanine","armaldo","aurorus","azumarill",
	"banette","bastiodon","bellossom","blissey","blastoise","blaziken","bronzong",
	"cacturne","camerupt","chandelure","charizard","cinderace","claydol","clefable","cloyster","corviknight","cradily","crawdaunt","crobat","cursola",
	"decidueye","delphox","dewgong","donphan","dragonite","drampa","drapion","drifblim","dugtrio","dusclops","dusknoir",
	"electivire","empoleon","exeggutor","exploud",
	"fearow","feraligatr","floatzel","florges","flygon","forretress","froslass","frosmoth",
	"gallade","galvantula","garchomp","gardevoir","gastrodon","gengar","glalie","gliscor","golduck","golem","golisopod","goodra","gorebyss","gothitelle","gourgeist","greninja","grumpig","gyarados",
	"hariyama","hatterene","heracross","hippowdon","hitmonchan","hitmonlee","hitmontop","honchkrow","houndoom","huntail","hypno",
	"incineroar","infernape",
	"jumpluff",
	"kabutops","kingdra","kingler",
	"lanturn","lapras","leavanny","lopunny","ludicolo","lumineon","luxray",
	"machamp","magcargo","magmortar","magnezone","mamoswine","mandibuzz","manectric","mantine","medicham","meganium","meowstic","metagross","milotic","mismagius","muk",
	"nidoking","nidoqueen","noivern",
	"octillery","omastar",
	"pidgeot","pinsir","politoed","poliwrath","porygon_z","primarina","primeape","probopass","purugly",
	"quagsire",
	"rampardos","rapidash","rhydon","rhyperior","roserade",
	"salamence","salazzle","samurott","sandslash","sawsbuck","sceptile","scizor","scorbunny","scrafty","seaking","serperior","sharpedo","shiftry","skarmory","skuntank","slaking","slowbro","slowking","snorlax","spiritomb","staraptor","starmie","steelix","stoutland","swalot","swampert","swellow","swoobat",
	"tangrowth","tauros","tentacruel","togekiss","torterra","toxicroak","tsareena","typhlosion","tyranitar",
	"ursaring",
