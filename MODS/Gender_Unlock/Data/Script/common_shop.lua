...
COMMON.ORBS = {
  ...
  { Index = "orb_luminous", Amount = 0, Price = 350},
  { Index = "orb_invert", Amount = 0, Price = 200},
  { Index = "orb_fill_in", Amount = 0, Price = 250},
  { Index = "orb_devolve", Amount = 0, Price = 150},
  { Index = "orb_all_aim", Amount = 0, Price = 150},
  { Index = "orb_trawl", Amount = 0, Price = 350},
  ...
  { Index = "orb_stayaway", Amount = 0, Price = 250},
  ...
  { Index = "orb_one_room", Amount = 0, Price = 350},
...
COMMON.SPECIAL = {
  ...
  { Index = "orb_escape", Amount = 0, Price = 150},
  { Index = "gender_capsule", Amount = 0, Price = 2000}
}
