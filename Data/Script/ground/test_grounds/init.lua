...
function test_grounds.Magnezone_Action(chara, activator)
  ...
  elseif quest == nil then
    ...
    if chres then
	  -- Type 0 = Rescue
	  SV.missions.Missions["OutlawQuest"] = { Complete = COMMON.MISSION_INCOMPLETE, Type = COMMON.MISSION_TYPE_OUTLAW, DestZone = "debug_zone", DestSegment = 4, DestFloor = 9, TargetSpecies = RogueEssence.Dungeon.MonsterID("riolu", 0, "normal", Gender.Male) }
